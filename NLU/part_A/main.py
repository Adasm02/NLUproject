...
bd_mode = params['bd_mode']
portion = params['portion']

base_path = os.path.abspath(os.path.dirname(__file__))
data_path = os.path.join(os.path.dirname(base_path), "part_A","dataset")
...
if __name__ == "__main__":
    ...
    for x in tqdm(range(0, runs)):
        model = ModelIAS(hid_size, out_slot, out_int, emb_size,dropout, bd_mode,
    ...
    store_model_with_params_and_lr(model, params, slot_f1s.mean(), slot_f1s.std(), intent_acc.mean(), intent_acc.std())
