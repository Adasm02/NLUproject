...
def load_datasets():
    ...
    train_text = read_file(os.path.join(data_path, "PennTreeBank/ptb.train.txt"))
    val_text = read_file(os.path.join(data_path, "PennTreeBank/ptb.valid.txt"))
    test_text = read_file(os.path.join(data_path, "PennTreeBank/ptb.test.txt"))
